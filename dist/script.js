...
/* harmony import */ var _modules_pictureShowUp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pictureShowUp */ "./src/js/modules/pictureShowUp.js");
...
addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_pictureShowUp__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
var modals = function modals() {
  ...
  function fixAbsolute(absoluteSelector) {
    ...
    absolute.forEach(function (item) {
      var rightM = getComputedStyle(item).right;

      if (document.body.style.overflow == 'hidden') {
        item.style.right = "calc(".concat(rightM, " + ").concat(scroll, "px)");
      } else {
        item.style.right = "calc(".concat(rightM, " - ").concat(scroll, "px)");
      }
    });
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeightCustom = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight);

      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeightCustom) {
  ...
  showModalByTime('.popup-consultation', 8000);
};
...
/***/ "./src/js/modules/pictureShowUp.js":
/*!*****************************************!*\
  !*** ./src/js/modules/pictureShowUp.js ***!
  \*****************************************/
/*! exports provided: default */
...
var pictureShowUp = function pictureShowUp() {
  var imgsWrapper = document.querySelector('.sizes-wrapper'),
  ...
  imgsWrapper.addEventListener('mouseover', function (e) {
    imgsBlocks.forEach(function (item, i) {
      item.classList.remove('animated', 'fadeIn');

      if (e.target && e.target == item) {
        // item.removeAttribute('src')
        item.classList.add('animated', 'fadeIn');
        item.setAttribute("src", "assets/img/sizes-".concat(i + 1, "-1.png"));
      }
    });
  });
  imgsWrapper.addEventListener('mouseout', function (e) {
    imgsBlocks.forEach(function (item, i) {
      if (e.target && e.target == item) {
        // item.removeAttribute('src')
...
/* harmony default export */ __webpack_exports__["default"] = (pictureShowUp);
